...
const fr: Dict = {
  ...
  "settings.emailSupport": "Contacter le support",
...
const de: Dict = {
  ...
  "settings.emailSupport": "Support per E-Mail",
...
const it: Dict = {
  ...
  "settings.emailSupport": "Email di supporto",
...
const pt: Dict = {
  ...
  "settings.emailSupport": "E-mail de suporte",
...
const ja: Dict = {
  ...
  "settings.emailSupport": "サポートにメール",
  "vocab.title": "ボキャブラリー",
  "vocab.all": "すべて",
...
const zh: Dict = {
  ...
  "settings.emailSupport": "给支持团队发邮件",
  "vocab.title": "词汇",
  "vocab.all": "全部",
  "vocab.empty": "还没有单词",
...
const ko: Dict = {
  ...
  "settings.emailSupport": "지원팀에 이메일",
  "vocab.title": "어휘",
  "vocab.all": "전체",
...
const ar: Dict = {
  ...
  "settings.emailSupport": "راسل الدعم",
...
const hi: Dict = {
  ...
  "settings.emailSupport": "सहायता को ईमेल करें",
